...
namespace MonitorSwap.Services
{
    internal enum TextKey
    {
        ...
        CaptureSuccess,
        AddExcludedWindow,
        RemoveExcludedWindow,
        ExcludedWindowHelp,
        AddExcludedWindowTitle,
        Add,
        SelectWindowToExclude,
        NoExcludedWindowCandidates,
        NoWindowSelected,
        MenuRotateLeft,
        MenuRotateRight,
        MenuSettings,
    ...
    internal static class AppLocalization
    {
        private static readonly Dictionary<TextKey, string> EnglishTexts = new Dictionary<TextKey, string>
        {
            ...
            { TextKey.GroupExcludedWindows, "Excluded Windows" },
            ...
            { TextKey.AddExcludedWindow, "Add Current..." },
            { TextKey.RemoveExcludedWindow, "Remove" },
            { TextKey.ExcludedWindowHelp, "Checked rules are excluded from monitor rotation." },
            { TextKey.AddExcludedWindowTitle, "Add Excluded Window" },
            { TextKey.Add, "Add" },
            { TextKey.SelectWindowToExclude, "Select a window to exclude from monitor rotation." },
            { TextKey.NoExcludedWindowCandidates, "No eligible windows are available to add." },
            { TextKey.NoWindowSelected, "Select a window first." },
        ...
        private static readonly Dictionary<TextKey, string> KoreanTexts = new Dictionary<TextKey, string>
        {
            ...
            { TextKey.GroupExcludedWindows, "\uC81C\uC678\uD560 \uCC3D" },
            ...
            { TextKey.AddExcludedWindow, "\uD604\uC7AC \uCC3D \uCD94\uAC00..." },
            { TextKey.RemoveExcludedWindow, "\uC0AD\uC81C" },
            { TextKey.ExcludedWindowHelp, "\uCCB4\uD06C\uB41C \uADDC\uCE59\uC740 \uBAA8\uB2C8\uD130 \uC21C\uD658 \uB300\uC0C1\uC5D0\uC11C \uC81C\uC678\uB429\uB2C8\uB2E4." },
            { TextKey.AddExcludedWindowTitle, "\uC81C\uC678\uD560 \uCC3D \uCD94\uAC00" },
            { TextKey.Add, "\uCD94\uAC00" },
            { TextKey.SelectWindowToExclude, "\uBAA8\uB2C8\uD130 \uC21C\uD658\uC5D0\uC11C \uC81C\uC678\uD560 \uCC3D\uC744 \uC120\uD0DD\uD558\uC138\uC694." },
            { TextKey.NoExcludedWindowCandidates, "\uCD94\uAC00\uD560 \uC218 \uC788\uB294 \uCC3D\uC774 \uC5C6\uC2B5\uB2C8\uB2E4." },
            { TextKey.NoWindowSelected, "\uBA3C\uC800 \uCC3D\uC744 \uC120\uD0DD\uD558\uC138\uC694." },
